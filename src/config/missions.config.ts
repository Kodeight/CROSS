...
export const MISSIONS: MissionDef[] = [
  ...
  { id: 'jungle_ch_1', name: 'JUNGLE: 2 near misses in one run', reward: 110, worldId: 'jungle', tier: 'challenge', requires: ['jungle_std_1', 'jungle_std_2'], check: (r) => r.nearMiss >= 2, progress: (r) => Math.min(r.nearMiss, 2) + '/2' },
  { id: 'jungle_ch_2', name: 'JUNGLE: Reach lane 70', reward: 120, worldId: 'jungle', tier: 'challenge', requires: ['jungle_std_1', 'jungle_std_2'], check: (r) => r.maxLane >= 70, progress: (r) => Math.min(r.maxLane, 70) + '/70' },
  { id: 'jungle_mas_1', name: 'JUNGLE: Reach lane 80 (world end)', reward: 260, worldId: 'jungle', tier: 'master', requires: ['jungle_ch_1', 'jungle_ch_2'], check: (r) => r.maxLane >= 80, progress: (r) => Math.min(r.maxLane, 80) + '/80' },
  // ---- WORLD 03 DESERT ----
  ...
  { id: 'desert_ch_1', name: 'DESERT: 3 near misses in one run', reward: 140, worldId: 'desert', tier: 'challenge', requires: ['desert_std_1', 'desert_std_2'], check: (r) => r.nearMiss >= 3, progress: (r) => Math.min(r.nearMiss, 3) + '/3' },
  { id: 'desert_ch_2', name: 'DESERT: Reach lane 110', reward: 150, worldId: 'desert', tier: 'challenge', requires: ['desert_std_1', 'desert_std_2'], check: (r) => r.maxLane >= 110, progress: (r) => Math.min(r.maxLane, 110) + '/110' },
  { id: 'desert_mas_1', name: 'DESERT: Reach lane 120 (world end)', reward: 320, worldId: 'desert', tier: 'master', requires: ['desert_ch_1', 'desert_ch_2'], check: (r) => r.maxLane >= 120, progress: (r) => Math.min(r.maxLane, 120) + '/120' },
  // ---- WORLD 04 SNOW ----
  ...
  { id: 'snow_ch_1', name: 'SNOW: 3 near misses in one run', reward: 170, worldId: 'snow', tier: 'challenge', requires: ['snow_std_1', 'snow_std_2'], check: (r) => r.nearMiss >= 3, progress: (r) => Math.min(r.nearMiss, 3) + '/3' },
  { id: 'snow_ch_2', name: 'SNOW: Reach lane 150', reward: 180, worldId: 'snow', tier: 'challenge', requires: ['snow_std_1', 'snow_std_2'], check: (r) => r.maxLane >= 150, progress: (r) => Math.min(r.maxLane, 150) + '/150' },
  { id: 'snow_mas_1', name: 'SNOW: Reach lane 160 (world end)', reward: 380, worldId: 'snow', tier: 'master', requires: ['snow_ch_1', 'snow_ch_2'], check: (r) => r.maxLane >= 160, progress: (r) => Math.min(r.maxLane, 160) + '/160' },
  ...
  { id: 'neon_ch_1', name: 'NEON: 4 near misses in one run', reward: 200, worldId: 'neon', tier: 'challenge', requires: ['neon_std_1', 'neon_std_2'], check: (r) => r.nearMiss >= 4, progress: (r) => Math.min(r.nearMiss, 4) + '/4' },
  { id: 'neon_ch_2', name: 'NEON: Reach lane 190', reward: 210, worldId: 'neon', tier: 'challenge', requires: ['neon_std_1', 'neon_std_2'], check: (r) => r.maxLane >= 190, progress: (r) => Math.min(r.maxLane, 190) + '/190' },
  { id: 'neon_mas_1', name: 'NEON: Reach lane 200 (world end)', reward: 440, worldId: 'neon', tier: 'master', requires: ['neon_ch_1', 'neon_ch_2'], check: (r) => r.maxLane >= 200, progress: (r) => Math.min(r.maxLane, 200) + '/200' },
  // ---- WORLD 06 BEACH ----
  ...
  { id: 'beach_ch_1', name: 'BEACH: 4 near misses in one run', reward: 230, worldId: 'beach', tier: 'challenge', requires: ['beach_std_1', 'beach_std_2'], check: (r) => r.nearMiss >= 4, progress: (r) => Math.min(r.nearMiss, 4) + '/4' },
  { id: 'beach_ch_2', name: 'BEACH: Reach lane 230', reward: 240, worldId: 'beach', tier: 'challenge', requires: ['beach_std_1', 'beach_std_2'], check: (r) => r.maxLane >= 230, progress: (r) => Math.min(r.maxLane, 230) + '/230' },
  { id: 'beach_mas_1', name: 'BEACH: Reach lane 240 (world end)', reward: 500, worldId: 'beach', tier: 'master', requires: ['beach_ch_1', 'beach_ch_2'], check: (r) => r.maxLane >= 240, progress: (r) => Math.min(r.maxLane, 240) + '/240' },
];
