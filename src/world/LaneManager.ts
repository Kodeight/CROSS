...
export class LaneManager {
  lanes: Lane[] = [];
  /** Active world's safe-ground dark tone (hex). New lanes are generated
   * with the world's own palette; this records the theme at transition so
   * lane lifecycle stays in sync until old lanes prune naturally. */
  worldTheme: number | null = null;
  ...
  /** Record the active world's safe-ground theme on world transitions. */
  setWorldTheme(safeDark: number): void {
    this.worldTheme = safeDark;
  }
